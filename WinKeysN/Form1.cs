...
using static WinKeysN.Helper;
using static WinKeysN.Properties.Settings;
...
namespace WinKeysN
{
    public partial class WinKeys : Form
    {
        ...
        {
            InitializeComponent();
            var winkbounds = new Rectangle(Default.winkeys_bounds_point, Default.winkeys_bounds_size);
            ...
            if (Default.lockon_name != null)
                moduleWindowNames = Default.lockon_name.OfType<string>();
        ...
        private void checkedWhiteListBox_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            var ents = Default.lockon_name ?? new StringCollection();
        ...
        void SaveWindow() => Task.Run(() =>
        {
            Default.winkeys_bounds_point = Bounds.Location;
            Default.winkeys_bounds_size = Bounds.Size;
            Default.Save();
        });
